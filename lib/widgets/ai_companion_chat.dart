...
class _AICompanionChatState extends ConsumerState<AICompanionChat> {
  ...
  Future<void> _pickFile() async {
    ...
    if (result != null) {
      ...
      String type =
          (name?.endsWith('jpg') ?? false) || (name?.endsWith('png') ?? false)
              ? 'image'
              : 'file';
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: _buildBackgroundBlob(
                      120, const Color(0xFF6366F1).withOpacity(0.08)),
                ),
                Positioned(
                  bottom: 100,
                  right: -40,
                  child: _buildBackgroundBlob(
                      180, const Color(0xFF8B5CF6).withOpacity(0.08)),
                ),
                Positioned(
                  top: MediaQuery.of(context).size.height * 0.3,
                  right: 20,
                  child: _buildBackgroundBlob(
                      60, const Color(0xFFEC4899).withOpacity(0.05)),
                ),
            ...
            child: ActionChip(
              label: Text(reply['text'] as String,
                  style: TextStyle(
                      ...
                      fontFamily: 'Cairo',
                      fontWeight: FontWeight.w600,
                      color: (reply['color'] as Color).withOpacity(1.0) ==
                              const Color(0xFFF1F5F9)
              ...
              side: BorderSide(
                  color: (reply['color'] as Color).withOpacity(0.5), width: 1),
              elevation: 0,
