...
class AccessibilityDialog extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start, // Changed to start (Right in RTL)
        children: [
          ...
          _buildNightModeControl(provider, ref, primaryColor),
          const SizedBox(height: 32),
          _buildContrastControl(provider, ref, primaryColor),
  ...
  Widget _buildNightModeControl(AppRiverpod provider, WidgetRef ref, Color primaryColor) {
    bool hc = provider.isHighContrast;
    bool dm = provider.isDarkMode;
    return Row(
      ...
      children: [
        Switch(
          ...
          activeThumbColor: (hc || dm) ? const Color(0xFF9FA8DA) : primaryColor,
        ),
  ...
  Widget _buildContrastControl(AppRiverpod provider, WidgetRef ref, Color primaryColor) {
    bool hc = provider.isHighContrast;
    bool dm = provider.isDarkMode;
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
