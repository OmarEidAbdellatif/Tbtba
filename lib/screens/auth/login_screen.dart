            ...
            builder: (context, child) {
              return Stack(
                children: [
                  ...
                  Positioned(
                    top: -100 + sin(_bgController.value * 2 * pi) * 50,
                    left: -50 + cos(_bgController.value * 2 * pi) * 50,
                    child: Container(
                  ...
                  Positioned(
                    bottom: -150 + cos(_bgController.value * 2 * pi) * 70,
                    right: -100 + sin(_bgController.value * 2 * pi) * 70,
                    child: Container(
                                  ...
                                  child: RichText(
                                    text: const TextSpan(
                                      style: TextStyle(
                                        ...
                                        fontFamily: 'Cairo', // ensure custom font is applied
                                      ),
                                      children: [
