...
class _AdminDashboardScreenState extends ConsumerState<AdminDashboardScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return TaptabaScaffold(
      ...
      title: 'إدارة دار الأمل لرعاية كبار السن', // عنوان التطبيق المعدل
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color:
                const Color(0xFF0f172a).withValues(alpha: 0.85), // لون داكن شبه شفاف
            border: Border(
                bottom: BorderSide(
                  ...
                  children: [
                    Flexible(
                      child: Column(
                        ...
                        children: [
                          const Text('دار الأمل لرعاية كبار السن',
                              maxLines: 1,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
              child: _buildNavItem(6, Icons.volunteer_activism_outlined, 'التطوع')),
        ],
      ),
    );
  }
